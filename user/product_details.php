...
if(isset($_POST["submit1"]))
{
    ...
    if($qty <= $quantity)
    {
       ...
       if(!isset($_COOKIE['item']) ) //IF user is first time 
       { 
            
            $total = $price * $qty;
            setcookie("item[$id]",$img."__".$nm."__".$price."__".$qty."__".$total,time()+3600*24*7);
                        ...
                        <div class="product-details"><!--product-details-->
                            <div class="col-sm-5">
                                <div class="view-product">
                                    <img src="../admin/product_image/<?php echo $row["product_image"];?>" alt="" />
